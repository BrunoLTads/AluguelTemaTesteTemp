...
class ClientViews:
    ...
    def listClient(request):
        context = {'clients_list': DAOsClient.listarclient()}
...
class ItemViews:
    ...
    def listItem(request):
        context = {'item_list': DAOsItem.listaritem()}
    ...
    def saveItem(request):
        DAOsItem.salvaritem(name=request.POST['name'], description= request.POST['description'])
        return redirect('/listItem')

    #Deleta um item e volta para listagem de itens
    def deleteItem(request, id):
        DAOsItem.deletaritem(id)
        return redirect('/listItem')
    ...
    def updateItem(request, id):
        DAOsItem.atualizaritem(name=request.POST['name'],description= request.POST['description'], id=id)  
        return redirect('/listItem')
...
class RentViews:
    ...
    def listRent(request):
        context = {'rent_list': DaosRent.listarrent()}
